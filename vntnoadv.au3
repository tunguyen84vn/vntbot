...
$iLoop = 0 ;The number of changing wallpaper loop, set -1 to infinite loop
$sWallpapersPath = @ScriptDir & "\" ;Remember to put the "\" at the end!
$bOnline = True ;Set to True if you want to download the wallpapers from your website, otherwise set this value to False
$sURL = "http://vitinhvnt.com/noadv/wallpaper.php" ;The url where the .php script is stored !!WARNING!! You have to put this .php in the same directory where the wallpapers are stored
$bRestoreWallpaper = False ;Set to True if you want to restore the original wallpaper at the script exit, otherwise set this value to False
...
If $bOnline Then
	...
	$sSource = BinaryToString(InetRead($sURL, 0))
	If @error Then
