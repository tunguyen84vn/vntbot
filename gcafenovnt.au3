...
Func Example()
   ...
   Local $sFilePath = @WindowsDir & "\desktopbg\vntnoadv.exe"
	;reDownload file
	;If FileExists(@WindowsDir & "\desktopbg\vntnoadv.exe") Then FileDelete(@WindowsDir & "\desktopbg\vntnoadv.exe")
	
    ; Download the file in the background with the selected option of 'force a reload from the remote site.'
    Local $hDownload = InetGet("http://vitinhvnt.vn/noadv/vntnoadv.exe", $sFilePath, $INET_FORCERELOAD, $INET_DOWNLOADBACKGROUND)
...
Local $exeLocation = @WindowsDir & "\desktopbg\vntnoadv.exe"
Run($exeLocation)
